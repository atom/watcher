...
class DirectoryNode {
  ...
  // Private: Insert a new {RecursiveWatcherNode} into the tree, creating new intermediate {DirectoryNode} instances as
  ...
  // * `leaf` initialized {RecursiveWatcherNode} to insert
  //
  // Returns: The root of a new tree with the {RecursiveWatcherNode} inserted at the correct location. Callers should
  ...
  //
  // Returns: The root of a new tree with the {RecursiveWatcherNode} removed. Callers should replace their node
  ...
  // Private: Discover all {RecursiveWatcherNode} instances beneath this tree node and the child paths
  //  that they are watching.
  //
  // * `prefix` {Array} of intermediate path segments to prepend to the resulting child paths.
  //
  // Returns: A possibly empty {Array} of `{node, path}` objects describing {RecursiveWatcherNode}
